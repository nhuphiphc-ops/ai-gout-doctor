...
# Just cut off the file at "      {/* Bottom Navigation Bar for Mobile */}"
idx = text.find('      {/* Bottom Navigation Bar for Mobile */}')
if idx != -1:
    text = text[:idx]

bottom_nav = '''      {/* Bottom Navigation Bar for Mobile */}
